  ...
  render() {
    ...
    return (
      <div className="tc mw80 center tl-l pv5 ph4">
        <h2 className="bg-white eau-bold f-2 blue1 mh3 pv2 ttu f-1-l dib-l ph4-l pv2-l mh0-l mb0-l">
          The Team
        </h2>
        <p className="blue1 open-sans f4 f3-l">
          Here are some of the talented smart people <br className="dn-l"/>
          that want to continue to make Washington <br className="dn-l"/>
          a safe and green place.
        </p>
